...
export const humanHelpSections: HelpSection[] = [
  {
    ...
    steps: [
      "Open Groundtruth and start with the top mode buttons: Project, Playtest, Map, Assets, and More.",
      ...
      "Move around, fight enemies, and use the Playtest, Map, Assets, and Debug workspaces to understand what the world is doing.",
    ],
    notes: [
      "The active workspace opens in a thin left rail. Use Hide Workspace when you want the viewport fully visible.",
      "Assets uses the main viewport as a dedicated preview workspace instead of squeezing preview into the sidebar.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Use Assets to inspect model load state, missing clips, warnings, and binding problems in the dedicated asset viewport.",
  ...
  },
  {
    ...
    notes: [
      ...
      "Assets now uses the full viewport for preview and can save semantic clip bindings plus per-slot playback speed, not just model fit and collision.",
